...
static int set_light_backlight(struct light_device_t *dev, struct light_state_t const* state)
{
     ...
     /* on victor(E730) screen turns off(or barely visible) for brightness below 16 */
     if(brightness < 16)
     	brightness = 16;
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
     ...
     name: "Victor Lights HAL",
     author: "Kolja Dummann <k.dummann@gmail.com>, Harsh Panchal <panchal.harsh18@gmail.com>",
